...
Anthropic has no embeddings API, so embedding generation should use the OpenAI or mock
provider; this module raises a clear error if asked to embed.
"""
...
class AnthropicLLMProvider(LLMProvider):
    ...
    async def complete(
        ...
        msg = await client.messages.create(
            model=self.model,
            max_tokens=1024,
            system=system or "You are an expert job-search assistant.",
